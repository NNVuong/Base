...
!function (o) {
    ...
    var n, a, r, i;
    e(), n = ".card", o(document).on("click", '.card a[data-bs-toggle="remove"]', function (e) {
        e.preventDefault();
        var e = o(this).closest(n), t = e.parent();
        ...
        var e = o(this).next(".dropdown-menu"), e = o(this).parent().parent().find(".dropdown-menu").not(e);
    ...
    })), a = o(".navbar-custom .dropdown:not(.app-search)"), o(document).on("click", function (e) {
        return "top-search" == e.target.id || e.target.closest("#search-dropdown") ? o("#search-dropdown").addClass("show") : o("#search-dropdown").removeClass("show"), !0
    }), o("#top-search").on("focus", function (e) {
        return e.preventDefault(), a.children(".dropdown-menu.show").removeClass("show"), o("#search-dropdown").addClass("show"), !1
        ...
        var n = o(t).data("maskFormat"), a = o(t).data("reverse");
...
var ThemeCustomizer = function () {
    ...
    return _createClass(e, [{
        ...
        key: "resetTheme", value: function () {
            this.config = JSON.parse(JSON.stringify(window.defaultConfig)), this.changeMenuColor(this.config.menu.color), this.changeLeftbarSize(this.config.sidenav.size), this.changeLayoutColor(this.config.theme), this.changeLayoutMode(this.config.layout.mode), this.changeLayoutPosition(this.config.layout.position), this.changeTopbarColor(this.config.topbar.color), this.changeSidebarUser(this.config.sidenav.user), this._adjustLayout()
        }
    }, {
        key: "initSwitchListener", value: function () {
            var n = this, e = (document.querySelectorAll("input[name=data-menu-color]").forEach(function (t) {
            ...
            }), document.getElementById("light-dark-mode")), e = (e && e.addEventListener("click", function (e) {
                "light" === n.config.theme ? n.changeLayoutColor("dark") : n.changeLayoutColor("light")
            }), document.querySelector("#reset-layout")), e = (e && e.addEventListener("click", function (e) {
                n.resetTheme()
            }), document.querySelector(".button-toggle-menu")), e = (e && e.addEventListener("click", function () {
                var e = n.config.sidenav.size, t = n.html.getAttribute("data-sidenav-size", e);
        ...
        key: "showBackdrop", value: function () {
        ...
        key: "hideBackdrop", value: function () {
        ...
        key: "initWindowSize", value: function () {
            var t = this;
        ...
        key: "setSwitchFromConfig", value: function () {
            // sessionStorage.setItem("__CONFIG__", JSON.stringify(this.config)), document.querySelectorAll("#theme-settings-offcanvas input[type=checkbox]").forEach(function (e) {
            //     e.checked = !1
            // });
            localStorage.setItem("__CONFIG__", JSON.stringify(this.config)), document.querySelectorAll("#theme-settings-offcanvas input[type=checkbox]").forEach(function (e) {
                e.checked = !1
            });
            var e, t, n, a, o, r, i, c, s = this.config;
            s && (e = document.querySelector("input[type=checkbox][name=data-layout][value=" + s.nav + "]"), t = document.querySelector("input[type=checkbox][name=data-bs-theme][value=" + s.theme + "]"), n = document.querySelector("input[type=checkbox][name=data-layout-mode][value=" + s.layout.mode + "]"), a = document.querySelector("input[type=checkbox][name=data-topbar-color][value=" + s.topbar.color + "]"), o = document.querySelector("input[type=checkbox][name=data-menu-color][value=" + s.menu.color + "]"), r = document.querySelector("input[type=checkbox][name=data-sidenav-size][value=" + s.sidenav.size + "]"), i = document.querySelector("input[type=radio][name=data-layout-position][value=" + s.layout.position + "]"), c = document.querySelector("input[type=checkbox][name=sidebar-user]"), e && (e.checked = !0), t && (t.checked = !0), n && (n.checked = !0), a && (a.checked = !0), o && (o.checked = !0), r && (r.checked = !0), i && (i.checked = !0), c && "true" === s.sidenav.user.toString() && (c.checked = !0))
        }
    }, {
